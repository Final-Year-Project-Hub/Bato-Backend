...
import { BadRequestException, ErrorCode, UnauthorizedException } from "../utils/root";
...
export const login = async(req:Request,res:Response,next:NextFunction) =>{
    ...
    if(!passwordMatch){
        throw new UnauthorizedException('Password does not match',ErrorCode.INVALID_CREDENTIALS)
    }
    ...
    .json(new ApiResponse("User logged in successfully", {user:loggedInUser,accessToken,refreshToken}));
...
export const logout = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      throw new UnauthorizedException("User not found", ErrorCode.UNAUTHORIZED_REQUEST);
    }
